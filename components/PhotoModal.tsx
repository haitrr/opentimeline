  ...
  return (
    <Dialog open onOpenChange={(open) => { if (!open) onClose(); }}>
      <DialogContent className="max-w-5xl border-none bg-transparent p-0 shadow-none [&>button]:text-white [&>button]:hover:text-white/80">
        <div className="relative flex max-h-[94vh] w-full flex-col">
          ...
          <div className="flex items-center justify-between rounded-b-lg bg-black/70 px-2 py-2 sm:px-3">
            <Button
              ...
              disabled={index === 0}
              className="text-white/70 hover:text-white hover:bg-white/10 disabled:opacity-25 text-2xl leading-none px-2"
            >
              ‹
            </Button>
