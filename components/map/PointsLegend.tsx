...
export default function PointsLegend({ deviceColors, hidePoints }: Props) {
  ...
  return (
    <div className="pointer-events-none absolute bottom-4 right-4 z-900 rounded-lg border border-gray-200 bg-white/90 px-3 py-2 shadow-md dark:border-gray-700 dark:bg-gray-900/90">
