...
import type { HourGroup, SerializedPoint } from "@/lib/groupByHour";

function TimelineItem({ point }: { point: SerializedPoint }) {
  return (
    <div className="flex items-start gap-2 py-2 pl-6 text-xs text-gray-600 hover:bg-gray-50 transition-colors">
  ...
  if (hourGroups.length === 0) {
    return (
      <div className="flex flex-1 items-center justify-center p-6 text-center">
        <div>
          <p className="text-sm text-gray-400">No location data for this day.</p>
